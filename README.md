...
R package **luscale**, version **2.27.11**
...
Dietrich J, Bodirsky B, Bonsch M, Patrick, von Jeetze, Kreidenweiss U, Hennig R, Humpenoeder F (2023). _luscale: PIK Landuse Group Data Scaling Tools_. doi:10.5281/zenodo.1158584 <https://doi.org/10.5281/zenodo.1158584>, R package version 2.27.11, <https://github.com/pik-piam/luscale>.
...
@Manual{,
  ...
  year = {2023},
  note = {R package version 2.27.11},
